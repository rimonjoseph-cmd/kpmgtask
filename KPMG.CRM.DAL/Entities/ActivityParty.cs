...
namespace KPMG.CRM.DAL
{
	...
	public partial class ActivityParty : Microsoft.Xrm.Sdk.Entity
	{
		...
		public KPMG.CRM.DAL.ActivityPointer ActivityPointer_Activity_Parties
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<KPMG.CRM.DAL.ActivityPointer>("activitypointer_activity_parties", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<KPMG.CRM.DAL.ActivityPointer>("activitypointer_activity_parties", null, value);
			}
		}
		...
		public KPMG.CRM.DAL.Contact Contact_Activity_Parties
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<KPMG.CRM.DAL.Contact>("contact_activity_parties", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<KPMG.CRM.DAL.Contact>("contact_activity_parties", null, value);
			}
		}
		...
		public KPMG.CRM.DAL.Email Email_Activity_Parties
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<KPMG.CRM.DAL.Email>("email_activity_parties", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<KPMG.CRM.DAL.Email>("email_activity_parties", null, value);
			}
		}
		...
		public KPMG.CRM.DAL.SystemUser System_User_Activity_Parties
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<KPMG.CRM.DAL.SystemUser>("system_user_activity_parties", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<KPMG.CRM.DAL.SystemUser>("system_user_activity_parties", null, value);
			}
		}
